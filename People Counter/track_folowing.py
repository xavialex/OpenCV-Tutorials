...
while(cap.isOpened()):
    ...
    for cnt in contours0:
        ...
        if area > areaTH:
            ...
            #   TRACKING    #
            #################            
            M = cv2.moments(cnt) # Nº que determinan ciertas características del contorno
            cx = int(M['m10']/M['m00']) # Posición x del centroide
            cy = int(M['m01']/M['m00']) # Posición y del centroide
            x, y, w, h = cv2.boundingRect(cnt) # Creación de un rectángulo sobre el contorno
